...
class Gaussian:
    ...
    def _parse_input_script(self, script: str) -> Dict[str, list[str]]:
    ...
    @staticmethod
    def _rewrite_gjf_file(info: Dict):
        """"""
        script = ""
    ...
    def run(self, script: str):
        ...
        script = self._rewrite_gjf_file(self.parsed_input)  # rewrite the gjf script to standard style
