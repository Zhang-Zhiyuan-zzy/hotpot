...
class SklearnWorkFlow:
    ...
    def __init__(
        ...
        Args:
            ...
            work_dir: working directory for saving ChemData and pictures when workflow running
    ...
    def train_surrogate_tree(
        ...
        Args:
            ...
            X(numpy.ndarray): input ChemData to generate estimator prediction and training the surrogate student decision,
    ...
    def partial_dependence_analysis(
        ...
        Args:
            origin_data: whether to use origin ChemData as test samples.
